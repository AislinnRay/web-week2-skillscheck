...
let me = {
    firstName: "Aislinn",
    superHeroName: "Doctor Macintosh",
    homeTown: "Middle of Nowhere",
    superPowers: ["telepathy", "invisibility", "flight"],
    superPowerXP: function() {
        return Math.floor((Math.random() * 100) + 1)
    },
    profileImage: function() {
        //return 'https://randomuser.me/api/portraits/med/lego/5.jpg'
        return 'https://randomuser.me/api/portraits/med/lego/${Math.floor(Math.random() * 10) + 1 }.jpg'
    }
}
//let superPowerXP = Math.floor((Math.random() * 100) + 1)
