...
let total = myNumbers.reduce(function(arr, element){
	return arr + element
})
...
notGeorge.map(function(element){
  ...
  var forTheLoveOfGeorge = notGeorge
...
let initialValue = 0
let totallyAwesome = people.reduce(function(total, currentValue){
	return total + currentValue.awesomeLevel;
},initialValue)
